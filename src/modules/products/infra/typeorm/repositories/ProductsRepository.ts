...
class ProductsRepository implements IProductsRepository {
  ...
  public async updateQuantity(
    ...
    const productsItem = await this.ormRepository.findByIds(products);

    const updateProducts = productsItem.map(productItem => {
      ...
      if (updatedProduct.quantity < productFind.quantity) {
